...
//     return {
//       status: moves.length === 9 || winner != null ? "complete" : "in-progress", // in-progress status
//       winner, // 1 | 2 | null(tie)
//     };
//   },
...
//     App.$.menuItems.addEventListener("click", (event) => {});
...
//         // Determine which players icon to add the square
...
//         // check if there is a tie or winner game
